    ...
    function wrapper() {
        ...
        try {
            ...
            if(canvasEles.length>0){ 
                    ...
                    function blobCallback(blob){
                        ...
                        oFileReader.onloadend = function (e) {
                            ...
                            if (base64.includes("data:image")) {
                                ...
                                completeFlag++;                                                         
                                document.querySelector(".num-tip").innerText=`抓取canvas图片第${completeFlag}/${canvasEles.length}张`;                                      
                ...
                fetchTip=`已选(0/${imgUrls.length})张图片`;
            }
...
<span style="margin-left:10px;" class="num-tip">${fetchTip}</span>
...
align-items:center;flex-wrap:wrap;">
    ...
    `
        ...
        document.querySelector(".select-all").onchange = (e) => {
            ...
            document.querySelector(".num-tip").innerText = `已选(${imgWaitDownload.length}/${filteredImgUrls.length})张图片`;
        }
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16" style="position:absolute;top:5px;right:5px;">
      ...
      <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"/>
        ...
        function getImgAndChangeToBase64(currentImgIndex) {
            ...
            GM_xmlhttpRequest({
                method: "get",
                url: filteredImgUrls[currentImgIndex],
                responseType: "blob",
                onload: function (r) {
                    var blob = r.response;
                    let oFileReader = new FileReader();
                    oFileReader.onloadend = function (e) {
                        ...
                        filteredImgUrls[currentImgIndex] = base64;
