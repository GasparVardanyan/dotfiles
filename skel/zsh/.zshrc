...
# alias ls="lsd -hFX"
alias ls="eza --group --icons -F -s type --group-directories-first --git"
...
alias yta="yt-dlp -R infinite --retry-sleep 10 --add-metadata --embed-thumbnail --convert-thumbnails jpg --ppa 'ThumbnailsConvertor:-q:v 1' -f bestaudio/best -x"
alias yt="yt-dlp -R infinite --retry-sleep 10 --add-metadata --embed-thumbnail --convert-thumbnails jpg --ppa 'ThumbnailsConvertor:-q:v 1' -f 'bestvideo+bestaudio/best'"
alias ytpa="yta --download-archive archive.txt"
alias ytpau="ytpa -a urls.txt"
